...
public class MyArrayListTest {
    ...
    public void finishAfterTest(TestInfo a_testInfo) {
        s_timer.stop();
        System.out.println("LOGGER: execution time of " + a_testInfo.getDisplayName() + " took " + s_timer.getElapsedTime() / 1000000 + "[ms]");
    }
    ...
    @ParameterizedTest(name = "testAddAll1 (Run: {index}): " +
            "a_array = {0}, a_parameter1 = {1}, a_answer = {2}")
    ...
    @ParameterizedTest(name = "testAddAll2 (Run: {index}): " +
            "a_array = {0}, a_parameter1 = {1}, a_parameter2 = {2}, a_answer = {3}")
...
//            "a_array = {0}, a_parameter = {1}, a_answer = {2}")
